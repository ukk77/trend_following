...
> `trend_following` · 22 files (python×22) · 32 classes · 25 functions · ~3,814 source lines
...
- `def generate_signal(ticker: str, ohlc: DataFrame, cfg: TrendFollowingConfig, sentiment_override: Optional) → Signal`  — Generate a trading signal for one ticker applying all 10 filter layers.
